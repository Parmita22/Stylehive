...
<head>
    ...
    <style type="text/css">
        <?php include 'style.css'; ?>.wishlist-box {
            width: 300px;
            padding: 20px;
            margin: 20px;
        ...
        .wishlist-box .button a,
        .wishlist-box .button button {
        ...
        .wishlist-box .button a:hover,
        .wishlist-box .button button:hover {
            background-color: #ccc;
        }

        .wishlist-box h3.name {
            font-size: 18px;
            margin-bottom: 10px;
        }
