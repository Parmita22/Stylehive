...
<head>
    ...
    <title>shopproject - adminpanel - register page</title>
</head>
            ...
            <div class="form-container" id="admin_login">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-field">
                        ...
                        <input type="password" name="password" maxlength="20" required placeholder="your password" oninput="this.value.replace(/\s/g,'')">
